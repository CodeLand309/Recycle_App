...
import com.example.recycle.MainUI.Notifications.Client;
import com.example.recycle.MainUI.Notifications.Data;
import com.example.recycle.MainUI.Notifications.MyResponse;
import com.example.recycle.MainUI.Notifications.Sender;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private String name, phone, Phone_Number, image, url = RestClient.BASE_URL + "user_image/";
    private int id;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot snapshot:dataSnapshot.getChildren()){
                    ...
                    Data data = new Data(Phone_Number, R.mipmap.ic_launcher_round, name+": "+message, "New Message", rec_phone);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    Log.d("my_id", my_phone);
                    Log.d("other_id", rec_phone);
//                    Log.d("getOtherphone", chat.getSender());
//                    Log.d("getMyphone", chat.getReceiver());
